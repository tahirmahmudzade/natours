...
exports.showAlert = function (type, msg) {
  hideAlert();
...
exports.logout = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var res;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFoeWlyciIsImEiOiJjbGN1YnpnbG4wdDAzM3BteGJmbm1xejlwIn0.RH67fFLpdDilydiZCsh17Q';
...
var _require = require('axios'),
  axios = _require.default;
var _require2 = require('./alerts'),
  showAlert = _require2.showAlert;
...
exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MSGdwLeJOwhHgksjXnrGmSjnbn9rjACzli5DlRHY1BJODKD5lRErw0FTlNzC4mpr4TXppgK6SHqmbKn1mWoozCQ00exlnDpVL');
          _context.next = 3;
          return axios({
...
var _require2 = require('./updateSettings'),
  updateSettings = _require2.updateSettings;
var _require3 = require('./stripe'),
  bookTour = _require3.bookTour;
...
},{"./login":"login.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}]},{},["index.js"], null)
